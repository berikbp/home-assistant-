#!/usr/bin/env python3
"""Continue best model (sac_20260911_154532) for 50k more steps (100k total)."""
import sys, os
...
model, meta = load_agent_model("sac_20260911_154532")
...
model.set_env(env)
print(f"Continuing {extra} more steps (total will be {meta['train_cfg']['timesteps']+extra})...")
...
save_agent("sac_100k", "SAC", model, metrics,
